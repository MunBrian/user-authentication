      ...
      <div className="bg-white basis-1/2 flex flex-col justify-center px-24 py-10">
        <div>
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            <div className="mb-5">
              <label className="block text-lightgrey text-base">
                First Name
              </label>
              <input
                name="firstname"
            ...
            <div className="mb-5">
              ...
              <p
                className={
                  emailExist ? "text-sm text-red font-medium" : "hidden"
                }
              >
            ...
            <div className="mb-5">
              ...
              <p
                className={
                  passwordLengthErr ? "text-sm text-red font-medium" : "hidden"
                }
              >
            ...
            <div className="mb-5">
              ...
              <p
                className={
                  passwordErr ? "text-sm text-red font-medium" : "hidden"
                }
              >
            ...
            <input
              type="submit"
              value="Sign Up"
              className="p-3 mb-3 bg-lightgreen rounded-md text-white font-semibold transition duration-500 ease-in-out hover:bg-darkgreen"
            />
          </form>
