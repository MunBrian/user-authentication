                  ...
                  <form className='flex flex-col' onSubmit={handleSubmit}>
                    ...
                    <input name="firstname" value={firstname} onChange={handleChange} className="border-lightgrey border-2 rounded-md w-full p-2.5 placeholder:text-darkgrey" type="text" required/>
                      ...
                      <div className='mb-5'>
                        ...
                        <input name="email" value={email} onChange={handleChange} className={emailErr || emailExist ? "border-red border-2 rounded-md w-full p-2.5 text-red focus:text-black" : "border-lightgrey border-2 rounded-md w-full p-2.5 placeholder:text-darkgrey"} type="email" placeholder='Abc@gmail.com' required />
                      ...
                      <div className='mb-5'>
                        ...
                        <input name="password" value={password} onChange={handleChange} className={passwordLengthErr ? "border-red border-2 rounded-md w-full p-2.5 text-red focus:text-black" : "border-lightgrey border-2 rounded-md w-full p-2.5 placeholder:text-darkgrey"} type="password" placeholder='*******' required />
                      ...
                      <div className='mb-5'>
                          <label className={ passwordErr ? 'block text-red text-base font-medium' : 'block text-lightgrey text-base' }>Confirm Password</label>
                           <input name="confirmPassword" value={confirmPassword} onChange={handleChange} className={passwordErr ? "border-red border-2 rounded-md w-full p-2.5 text-red focus:text-black" : "border-lightgrey border-2 rounded-md w-full p-2.5 placeholder:text-darkgrey"} type="password" placeholder='*******' required />
